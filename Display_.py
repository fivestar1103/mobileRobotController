...
class OperatorInterface:
    ...
    def open_result_window(self):
        ...
        spot_pairs = [pair.strip().split() for pair in spot_data.split(',')]
        color_blob_pairs = [pair.strip().split() for pair in color_data.split(',')]
        hazard_pairs = [pair.strip().split() for pair in hazard_data.split(',')]
